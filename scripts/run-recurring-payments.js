...
// 환경 변수 확인
const SUPABASE_URL =
  process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ihetobtbmgumwqlapsvl.supabase.co';
...
async function runRecurringPayments() {
  try {
    ...
    const response = await axios.get(`${SUPABASE_URL}/functions/v1/process-recurring-payments`, {
      headers: {
